...
export default function FolderInteraction() {
  ...
  const pageVariants = {
    spring: { type: 'spring', duration: 0.6 },
  };
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <button
        ...
        className="wrapper relative h-40 w-60 cursor-pointer border-0 bg-transparent p-0 sm:h-44 sm:w-72"
        aria-label={isOpen ? 'Close folder preview' : 'Open folder preview'}
      >
        <div
          className="folder relative mx-auto flex h-full w-[87.5%] items-center justify-center"
          style={{
            background: '#18151B',
            boxShadow: '0px 0px 15.699999809265137px 16px rgba(79, 73, 85, 0.30) inset',
            borderRadius: 10,
          }}
        >
          {[
            ...
            <motion.div
              ...
              className={`absolute top-2 h-fit w-24 rounded-xl sm:w-28 ${page.className}`}
            >
              <Page />
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="absolute -bottom-px -left-px -right-px z-20 flex h-32 origin-bottom items-center justify-center overflow-visible rounded-3xl sm:h-36"
        >
          <svg
          ...
          >
            <foreignObject x="-13" y="-13" width="262.4" height="148.4">
              <div
                style={{
                  ...
                  clipPath: 'url(#folder-bgblur-clip-path)',
                  height: '100%',
                  width: '100%',
                }}
              />
            ...
            <path
              ...
              fill="url(#folder-fill-gradient)"
              fillOpacity="0.3"
              stroke="url(#folder-stroke-gradient)"
              strokeWidth="0.7"
            />
            <defs>
              <clipPath id="folder-bgblur-clip-path" transform="translate(13 13)">
